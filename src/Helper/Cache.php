...
class Cache
{
     ...
     */
    private $cachePath = _PS_CACHE_DIR_ . 'pixel_sucuri';
    ...
    {
        return rtrim($this->cachePath, DIRECTORY_SEPARATOR)  . DIRECTORY_SEPARATOR;
    }
     ...
     * @return Cache
     */
    public function setExtension(string $extension): Cache
    {
